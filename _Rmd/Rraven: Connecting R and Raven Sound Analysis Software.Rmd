...
kable(head(rvn.dat[,1:6]), align = "c", row.names = F,  format = "html")
```
 &nbsp; 
...
kable(head(rvn.dat[,7:ncol(rvn.dat)]), align = "c", row.names = F,  format = "html")
...
```{r, eval = TRUE, echo = FALSE, message = FALSE, warning = FALSE, cache.comments=FALSE, comment=F}
...
names(rvn.dat)[grep("channel", names(rvn.dat))] <- "channel"

knitr::kable(head(rvn.dat[,-2]), align = "c", row.names = FALSE, format = "html")
...
knitr::kable(head(sp[,1:6]), align = "c", row.names = FALSE,  format = "html")
...
knitr::kable(head(sp[,6:15]), align = "c", row.names = FALSE,  format = "html")
...
kable(head(fcts[ ,1:14]), align = "c", row.names = FALSE,   format = "html")
```
...
```{r, eval=T, echo=FALSE}
knitr::kable(head(fcts[ ,39:53]), align = "c", row.names = FALSE,   format = "html")
...
kable(head(fcts[ ,21:32]), align = "c", row.names = FALSE,   format = "html")
...
#check original column names
kable(st1, align = "c", row.names = FALSE,   format = "html")
```
...
#check original column names
kable(rc, align = "c", row.names = FALSE,   format = "html")
```
 &nbsp; 
...
kable(rc, align = "c", row.names = F,   format = "html")
```
 &nbsp; 
