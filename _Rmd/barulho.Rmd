...
```{r barulho1, eval = FALSE, echo = FALSE}
...
```{r barulho3, eval = TRUE, echo = FALSE, message=FALSE}
...
```{r barulho5, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/analysis_workflow.jpg")
...
```{r barulho7, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/spectro_synth_song.png")
...
```{r barulho9, eval = TRUE, echo=FALSE}

c("list")

```

```{r barulho10, eval = FALSE}

names(synth.l)

```

```{r barulho11, eval = TRUE, echo=FALSE}

c("selec.table", "wave")

```

```{r barulho12, eval = FALSE}

synth.l$selec.table  

```

```{r barulho13, eval = FALSE, echo = FALSE}
...
```{r barulho15, eval = TRUE, echo=FALSE}
...
```{r barulho17, eval = FALSE, echo = TRUE}
...
```{r barulho18, eval=FALSE, echo=TRUE}
...
```{r barulho19, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/synthetic_master.wav.jpeg")
...
```{r barulho20, eval = FALSE, echo = TRUE}
...
```{r barulho21, eval=FALSE, echo=TRUE}
...
```{r barulho22, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/example_master.wav.jpeg")
...
```{r barulho24, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/example_master_table.jpg")
...
```{r barulho25, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/align-crop-optimize.gif")
...
```{r barulho28, eval = FALSE, echo=FALSE}
...
```{r barulho31, eval = TRUE, echo = FALSE}

print(TRUE)

```

```{r barulho32, eval = FALSE,  echo = FALSE}
...
```{r barulho33, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/example_test1.wav.jpeg")

```

&nbsp;

```{r barulho34, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/example_test2.wav.jpeg")
...
```{r barulho35, out.width = "800px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/tlalpan_playback.jpeg")
...
```{r barulho38, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/spcc_align_results.gif")
...
```{r barulho40, eval = TRUE, echo = FALSE}
...
```{r barulho42, eval = FALSE}

table(playback_est$signal.type, playback_est$distance)

```

```{r barulho43, eval = TRUE, echo=FALSE}
...
```{r barulho45, eval = TRUE, echo = FALSE}
...
```{r barulho49, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/blur_ratio_example.gif")
...
```{r barulho53, eval = TRUE, echo = FALSE}
...
```{r barulho56, out.width = "600px", echo = FALSE, fig.align= "center"}

knitr::include_graphics("./img/spectral_blur_ratio_example.gif")
...
```{r barulho60, eval = FALSE}
# print output
ec
```

```{r barulho61, echo = FALSE}
...
```{r barulho63, eval = FALSE}
# print output
sc
```

```{r barulho64, echo = FALSE}
...
```{r barulho66, eval = FALSE}
# print output
sa
```

```{r barulho67, echo = FALSE}
...
```{r barulho69, eval = FALSE}
# print output
spd
```

```{r barulho70, echo = FALSE}
