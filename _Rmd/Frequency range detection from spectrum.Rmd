...
Phae.stri <- list(readWave("Phaethornis-striigularis-154074.wav"), ad)
...
kbl <- kable(fr.ad, align = "c", row.names = F,  format = "html")

scroll_box(kbl, width = "740px",  height= "600px",
...
sp <- specan(X = fr.ad, wl = 200, bp = "frange", ovlp = 90, 
