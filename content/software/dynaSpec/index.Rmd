...
<img src="/post/dynaSpec_sticker.png" alt="dynaSpec sticker" align="right" width = "25%" height="25%"/>
...
<img src="colored_spectro_house_wren_duet.png" alt="house wren duet">
...
![Static Spectrogram of a female barn swallow song](femaleBarnSwallow_1.png)
...
```
![Static spectrogram with axis labels for female barn swallow song](femaleBarnSwallow_1b.png)
...
pagedSpec(p2) 
```
![Static spectrogram with axis labels for female barn swallow song](femaleBarnSwallow_1c.png)
...
![Humpback whale song spectrogram](humpback.png)
